...
public class ThreadExam {
	...
	public static void main(String[] args) {
		...
		// 바로 밑에 있는 계산결과를 출력하는 형태 였음
		
		// 병렬적
		// 해당 시점에 실행 흐름이 동시에 실행되고 있는 것
		...
		// 자바에서 스레드 사용
		// java8 버전에서는 사용자 레벨 스레드는 안씀.
		// jvm 을 통해 OS로 부터 시스템 콜을 호출
		// -> 그후 커널 스레드를 할당받음
		
		Thread thread1 = new Thread(runnable);
		// start 메서드가 호출되면 그제서야 커널 스레드 요청.
		thread1.start();
