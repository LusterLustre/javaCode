...
// ChildClass와 ChildClass2는 얼핏 보기에 형제 관계로 보일 수 있지만
// 클래스에서 형제 관계는 없다.
...
public class Inheritance {
	...
	public static void main(String[] args) {
		// 상속 : 기존 클래스를 재사용하여 새로운 클래스를 작성하는것
		...
		// 2. 코드의 재사용성을 극대화.
		//   - 코드를 공통적으로 관리해서 그냥 호출만 해주면 된다.
		// 3. 코드의 추가와 변경이 쉬움
		
		// 상속시 주의사항
		// 자바에서는 다중상속은 지원하지 않음.
		// extends 키워드 뒤에는 단 하나의 부모 클래스만 와야한다.
		// 자식 클래스에서 선언한 필드와 메서드는 부모 클래스에서 사용불가.
		...
		// 하나의 거대한 클래스를 작성하는것보다 단위별로 여러개의 클래스를 작성한 후
		// 이 단위 클래스들을 포함 관계로 재사용하면 손쉽게 클래스를 작성할 수 있다.
