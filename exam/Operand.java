...
public class Operand {
	...
	public static void main(String[] args) {
		...
		// a *= b : 변수 a에 b의 내용을 곱한 후 결과값을 할당.
		// a /= b : 변수 a에 b의 내용을 나눈 후 몫 값을 할당.
		// a %= b : 변수 a에 b의 내용을 나눈 후 나머지값을 할당.
		// a &= b : 변수 a에 b의 내용을 and 연산 후 결과값을 할당.
		// a |= b : 변수 a에 b의 내용을 or 연산 후 할당.
		// a ^= b : 변수 a에 b의 내용을 xor 연산 후 할당.
		int a = 4, b = 5;
//		a += b; // a = a+b
...
//		System.out.print(b);
		...
		// AND OR 조건
		// 1. 회원가입을 받는데 조건이 나이가 20살 이상이거나 학력이 대졸인 사람
		// - OR 조건
